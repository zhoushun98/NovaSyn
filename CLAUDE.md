...
- `localeSwitchLabels` in `site-content.ts` controls the label and `aria-label` shown in the language dropdown for each locale. All labels are English abbreviations (EN, ZH, DE, FR, JA).
